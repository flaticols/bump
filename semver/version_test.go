...
func TestParse(t *testing.T) {
	tests := []parseTestsInput{
		...
		{nil, "v1.2.3", Version{nil, nil, 1, 2, 3}, false},
		{nil, "v1.2.3", Version{nil, nil, 1, 2, 3}, false},
		{nil, "v1.2.3-beta", Version{[]string{"beta"}, nil, 1, 2, 3}, false},
		{nil, "v1.0.5-beta.1", Version{[]string{"beta", "1"}, nil, 1, 0, 5}, false},
		{nil, "v1.2.3+build", Version{nil, []string{"build"}, 1, 2, 3}, false},
		{nil, "v1.2.3-beta+build", Version{[]string{"beta"}, []string{"build"}, 1, 2, 3}, false},
		{nil, "v1.2.3-beta.1+build.123", Version{[]string{"beta", "1"}, []string{"build", "123"}, 1, 2, 3}, false},
		{nil, "1.2.3", Version{nil, nil, 1, 2, 3}, false},
